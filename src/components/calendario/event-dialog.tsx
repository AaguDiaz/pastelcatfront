...
import {
  ...
  EndHour,
  StartHour,
} from "@/components/calendario/constants"
...
export function EventDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[425px] bg-pastel-cream">
        <DialogHeader>
          <DialogTitle>{event?.id ? "Editar evento" : "Crear evento"}</DialogTitle>
          <DialogDescription className="sr-only">
            {event?.id
              ? "Editar los detalles de este evento"
              ...
              <Popover open={startDateOpen} onOpenChange={setStartDateOpen}>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    variant={"outline"}
                    className={cn(
                      "group bg-pastel-beige hover:bg-background border-input w-full justify-between px-3 font-normal outline-offset-0 outline-none focus-visible:outline-[3px]",
                  ...
                  >
                    ...
                    <RiCalendarLine
                      size={16}
                      className="bg-pastel-cream text-muted-foreground/80 shrink-0"
                      aria-hidden="true"
                    />
                  </Button>
                </PopoverTrigger>
