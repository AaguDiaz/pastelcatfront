...
import { DefaultStartHour } from "@/components/calendario/constants"
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
          ...
          >
            {week.map((day, dayIndex) => {
              ...
              return (
                <div
                  key={day.toString()}
                  className="group border-border/70 data-outside-cell:bg-muted/40 data-outside-cell:text-muted-foreground/80 border-r border-b last:border-r-0"
                            ...
                            >
                              ...
                              >
                                <div>
                                  {!event.allDay && (
                                    <span>
                                      {format(new Date(event.start), "h:mm", { locale: es })}{" "}
                                    </span>
                                  )}
                                  {event.title}
                                </div>
