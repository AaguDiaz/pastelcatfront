    ...
    <div className="w-full">
      <Combobox value={value} onChange={onSelect}>
        ...
        <Transition
          ...
          afterLeave={() => setQuery('')}
        >
          <Combobox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
